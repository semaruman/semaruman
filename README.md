...
Building backend systems with a focus on **clean architecture, domain modeling, data access and testing**.
...
**Backend** · Web API · Minimal API · DI · Middleware · Authorization · Logging

**Architecture** · DDD · CQRS · Vertical Slice · Clean Architecture · SOLID

**Data** · PostgreSQL · SQL · EF Core · Dapper · LINQ
...
Building my own startup and focusing on **backend architecture, DDD and software design**.
